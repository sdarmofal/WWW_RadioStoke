...
if ( @$_GET['license'] == 'edit' || @$_POST['license'] == 'edit' )
{
	define('MODULE_ID', 69);
}
else if ( @$_GET['license'] == 'delete' || @$_POST['license'] == 'delete' )
{
	define('MODULE_ID', 70);
}
else
...
if( !empty($setmodules) )
{
    ...
    $module['Download2']['Alicense'] = "$file?license=add";    
    $module['Download2']['Elicense'] = "$file?license=edit";    
    $module['Download2']['Dlicense'] = "$file?license=delete";
	return;
}
	...
	switch($license)
	{
		case 'add':
		{
			...
			if ($add == 'do')
			{
				...
				$text = str_replace(array("\n", "\r"), array("<br />", ''), $form['text']);

				$sql = "INSERT INTO " . PA_LICENSE_TABLE . " (license_name, license_text) VALUES('" . $form['name'] . "', '" . $text . "')";
