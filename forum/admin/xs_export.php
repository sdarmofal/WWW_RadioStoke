...
if(!empty($export) && @file_exists($phpbb_root_path . $template_dir . $export . '/theme_info.cfg'))
{
	...
	$template->assign_vars(array(
			...
			'EXPORT_TEMPLATE'	=> xhtmlspecialchars($export),
			...
			'SEND_DATA_DIR'		=> isset($xs_send['dir']) ? xhtmlspecialchars($xs_send['dir']) : '',
			'SEND_DATA_HOST'	=> isset($xs_send['host']) ? xhtmlspecialchars($xs_send['host']) : '',
			'SEND_DATA_LOGIN'	=> isset($xs_send['login']) ? xhtmlspecialchars($xs_send['login']) : '',
			'SEND_DATA_FTPDIR'	=> isset($xs_send['ftpdir']) ? xhtmlspecialchars($xs_send['ftpdir']) : '',
