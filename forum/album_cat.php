...
if ($total_pics > 0)
{
	...
	generate_pagination(append_sid("album_cat.$phpEx?cat_id=$cat_id&amp;sort_method=$sort_method&amp;sort_order=$sort_order"), $total_pics, $pics_per_page, $start);
}
else
{
...
$album_jumpbox .= $lang['Jump_to'] . ':&nbsp;<select name="cat_id" onchange="this.form.submit()">';
