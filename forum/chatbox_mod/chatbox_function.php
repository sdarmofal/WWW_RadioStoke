...
function write_msg($nick, $msg)
{
	...
	$sql = "INSERT INTO ".$table_chatbox_name." VALUES ('','".$db->sql_escape($nick)."','".$db->sql_escape($msg)."','".CR_TIME."')";
...
function user_join($usernick,$status)
{
	...
	$sql = "DELETE FROM ".$table_chatbox_session_name." WHERE username = '".$db->sql_escape($usernick)."'";
    ...
    $sql = "INSERT INTO ".$table_chatbox_session_name." (username, lastactive, laststatus) VALUES ('" . $db->sql_escape($usernick) . "', '".CR_TIME."', '" . $db->sql_escape($status) . "')";
...
function user_active($usernick)
{
    ...
    $sql = "UPDATE ".$table_chatbox_session_name." SET lastactive = '".CR_TIME."' WHERE username = '".$db->sql_escape($usernick)."'";
...
function isuser_active($usernick)
{
    ...
    $sql = "SELECT lastactive FROM " . $table_chatbox_session_name . " WHERE username = '" . $db->sql_escape($usernick) . "'";
