...
$lang['By_date'] = 'By Date (Newest first)';
$lang['By_download'] = 'By Downloads';
$lang['By_rated'] = 'By Top Rated';
$lang['Latest_downloads'] = 'Latest Downloads';
$lang['Most_downloads'] = 'Most Downloads';
...
$lang['Stats_portal'] = "<tr><td class='row1' align='$portal_config[download_pos]'><span class='gensmall'>All files: {total_files}</span></td></tr>";
$lang['Stats_portal'] .= "<tr><td class='row2' align='$portal_config[download_pos]'><span class='gensmall'>Top rating: <a href=\"{u_popular}\">{popular}</a></span></td></tr>";
$lang['Stats_portal'] .= "<tr><td class='row1' align='$portal_config[download_pos]'><span class='gensmall'>Top downloads: <a href=\"{u_most_dl}\">{most_dl}</a></span></td></tr>";
$lang['Stats_portal'] .= "<tr><td class='row2' align='$portal_config[download_pos]'><span class='gensmall'>Last file: <a href=\"{u_newest_file}\">{newest_file}</a></span></td></tr>";
$lang['Stats_portal'] .= "<tr><td class='row1' align='$portal_config[download_pos]'><span class='gensmall'>Last top downloads: <a href=\"{u_least_dl}\">{least_dl}</a></span></td></tr>";
$lang['Stats_portal'] .= "<tr><td class='row2' align='$portal_config[download_pos]'><span class='gensmall'>Last top rating: <a href=\"{u_lpopular}\">{lpopular}</a></span></td></tr>";

// Rate
$lang['Rate'] = 'Rate File';
$lang['Rerror'] = 'Sorry, you have already rated this file.';
$lang['Rateinfo'] = 'You are about to rate the file <i>{filename}</i>.<br />Please select a rating. 1 is the worst, 10 is the best.';
...
$lang['Comment_add'] = 'Post a comment'; 
...
$lang['you_have_login'] = "You have to";
