...
if ($search == 'do')
{
	...
	$locbar = '<span class="nav"><a href="' . append_sid("index.$phpEx") . '" class="nav">' . $board_config['sitename'] . '</a> &raquo; <a href="' . append_sid("dload.php") . '" class="nav">' . $config[settings_dbname] . '</a> &raquo; <a href="' . append_sid("dload.php?action=search") . '" class="nav">' . $lang['Search'] . '</a> &raquo; ' . $lang['Results'] . ' ' . $string . '</span>';
    ...
    else
    {
        ...
        while ($r = $db->sql_fetchrow($result))
        {
            ...
            {
                $posticon = '<img src="pafiledb/icons/' . $r['file_posticon'] . '" alt="" />';
            }
...
if (empty ($search))
{
	...
	$locbar = '<span class="nav"><a href="' . append_sid("index.$phpEx") . '" class="nav">' . $board_config['sitename'] . '</a> &raquo; <a href="' . append_sid("dload.php") . '" class="nav">Download</a> &raquo;  <a href="' . append_sid("dload.php?action=search") . '" class="nav">' . $lang['Search'] . '</a></span>';
